...
export const HEROES: HeroDef[] = [
  h({
    id: "fool", pack: "circle", roman: "0", name: "The Star Ascendant", title: "0 · The Star Ascendant",
    animal: "Otter", form: "otter", element: "Astral", suit: "The Fool",
    weapon: "Star Wand", weaponKind: "staff",
    phrase: "Leap without fear. The path is what I become.",
    meaning: "Beginnings, spontaneity, unlimited potential.",
    color: 0x6a48c4, accent: 0xd4af37, portrait: "/cards/fool.jpg",
    hp: 92, speed: 7.4, fireRate: 0.26, damage: 13, shots: 1, projectileSpeed: 18,
    passive: "Wildcard shots. Astral orbs circle the Star Ascendant.",
  ...
  h({
    id: "swords", pack: "circle", roman: "⚔", name: "The Windblade Sentinel", title: "Swords · The Windblade Sentinel",
    animal: "Feline", form: "lynx", element: "Air", suit: "Swords",
    weapon: "Twin Windblades", weaponKind: "blades",
    phrase: "I cut through illusion. Clarity is my blade.",
    meaning: "Intellect, truth, conflict, decision.",
    color: 0x2e6fd8, accent: 0xd4af37, portrait: "/cards/swords.jpg",
    hp: 88, speed: 6.8, fireRate: 0.22, damage: 11, shots: 2, projectileSpeed: 22,
    passive: "Dual shot that pierces, carried by wind crests.",
  ...
  h({
    id: "pentacles", pack: "circle", roman: "★", name: "The Rootward Sage", title: "Pentacles · The Rootward Sage",
    animal: "Rabbit", form: "rabbit", element: "Earth", suit: "Pentacles",
    weapon: "Pentacle Disc", weaponKind: "coin",
    phrase: "I build what is real. From intention, I create.",
    meaning: "Material world, prosperity, manifestation.",
    color: 0x3a9d4d, accent: 0xd4af37, portrait: "/cards/pentacles.jpg",
    hp: 110, speed: 5.6, fireRate: 0.3, damage: 15, shots: 1, projectileSpeed: 16,
    passive: "40% more gold. A pentacle disc anchors each manifestation.",
  ...
  h({
    id: "wands", pack: "circle", roman: "🔥", name: "The Emberhand Prophet", title: "Wands · The Emberhand Prophet",
    animal: "Raven", form: "raven", element: "Fire", suit: "Wands",
    weapon: "Burning Staff", weaponKind: "wand",
    phrase: "I spark the flame. My will shapes the world.",
    meaning: "Creativity, willpower, action.",
    color: 0xc0392b, accent: 0xd4af37, portrait: "/cards/wands.jpg",
    hp: 96, speed: 6.2, fireRate: 0.28, damage: 17, shots: 1, projectileSpeed: 17,
    passive: "Shots burn and spread. A flame spirit follows the Prophet.",
  ...
  h({
    id: "cups", pack: "circle", roman: "C", name: "The Tidekeeper", title: "Cups · The Tidekeeper",
    animal: "Turtle", form: "turtle", element: "Water", suit: "Cups",
    weapon: "Gem Cup", weaponKind: "chalice",
    phrase: "I hold space for all. Love is my invocation.",
    meaning: "Emotion, intuition, healing.",
    color: 0x2f9dd6, accent: 0xd4af37, portrait: "/cards/cups.jpg",
    hp: 100, speed: 5.8, fireRate: 0.32, damage: 12, shots: 1, projectileSpeed: 16,
    passive: "8% lifesteal and splash. The shell carries a luminous gem cup.",
  ...
  h({
    id: "world", pack: "circle", roman: "XXI", name: "The Worldbringer", title: "XXI · The Worldbringer",
    animal: "Dragon", form: "dragon", element: "Cosmos", suit: "The World",
    weapon: "Twin-Orb Staff", weaponKind: "staff",
    phrase: "I unite all paths. The circle is complete.",
    meaning: "Completion, unity, wholeness.",
    color: 0xe8e6df, accent: 0xd4af37, portrait: "/cards/world.jpg",
    hp: 104, speed: 6.3, fireRate: 0.25, damage: 14, shots: 1, projectileSpeed: 18,
    passive: "Two orbiting shards. Green cosmic wings carry the circle whole.",
