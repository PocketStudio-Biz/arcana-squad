...
export const CODEX: Partial<Record<HeroId, Sheet>> = {
  fool: {
    ...
    diagram: "fan",
    materials: ["astral wool", "gold filigree", "wildcard gem", "cedar staff"],
    prop: "Wildcard Staff",
  },
  swords: {
    ...
    diagram: "dual",
    materials: ["gilded plate", "air-steel", "turtle shell", "twin longswords"],
    prop: "Dual Blades",
  },
  pentacles: {
    ...
    diagram: "nova",
    materials: ["earth silk", "minted gold", "otter fur", "seal coin"],
    prop: "Magic Coin",
  },
  wands: {
    ...
    diagram: "ring",
    materials: ["scale hide", "ember wood", "brass", "willfire core"],
    prop: "Wand Staff",
  },
  cups: {
    ...
    diagram: "tide",
    materials: ["tide silk", "pearl", "shell", "sacred chalice"],
    prop: "Sacred Chalice",
  },
  world: {
    ...
    diagram: "orbit",
    materials: ["cosmic scale", "white gold", "twin batons", "circle shard"],
    prop: "Twin Batons",
  },
};
